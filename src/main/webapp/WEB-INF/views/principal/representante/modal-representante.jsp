...
<div id="remover-representante" class="modal grey lighten-5">
    <div class="modal-content">
        <h5 class="thin">
            <i class="material-icons grey-text text-darken-2 small left">delete</i> Remover Representante
        </h5>
        <p class="red-text text-lighten-2">Tem certeza que deseja remover este representante?</p>
        <br/>
        <ul class="collection">
    ...
    <div class="modal-footer">
        <a href="" ng-click="removerRepresentante(us)" class=" modal-action modal-close waves-effect waves-light blue lighten-2 btn left" style="margin-left: 20px">
            <i class="material-icons right">thumb_up</i> Remover
        </a>

        <button ng-click="fecharModalRepresentante('remover')" class="btn-floating waves-effect waves-light red lighten-2 right" type="button" style="margin-right: 20px">
...
<!-- EDITAR CLIENTE -->
<div id="editar-representante" class="modal grey lighten-5">
    <div class="modal-content">
        <h5 class="thin">
    ...
    <div class="modal-footer">
        <a href="" ng-click="editarRepresentante(us)" class=" modal-action modal-close waves-effect waves-light blue lighten-2 btn left" style="margin-left: 20px">
            <i class="material-icons right">thumb_up</i> Editar
        </a>

        <button ng-click="fecharModalRepresentante('editar')" class="btn-floating waves-effect waves-light red lighten-2 right" type="button" style="margin-right: 20px">
            <i class="material-icons right">thumb_down</i>
        </button>
    </div>
    <br/>
